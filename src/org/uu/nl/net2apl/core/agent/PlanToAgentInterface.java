...
import org.uu.nl.net2apl.core.plan.builtin.ConcurrencyContext;
import org.uu.nl.net2apl.core.plan.builtin.DecoupledPlanBodyInterface;
import org.uu.nl.net2apl.core.plan.builtin.EnhancedTriggerInterceptor;
import org.uu.nl.net2apl.core.plan.builtin.EnhancedTriggerInterceptorBuilder;
import org.uu.nl.net2apl.core.plan.builtin.InstantiableRunOnceDecoupledPlan;
import org.uu.nl.net2apl.core.plan.builtin.InternalTriggerReturnValue;
import org.uu.nl.net2apl.core.plan.builtin.NoConcurrencyContextException;
import org.uu.nl.net2apl.core.plan.builtin.RunOncePlan;
import org.uu.nl.net2apl.core.plan.builtin.SubPlanInterface;
import org.uu.nl.net2apl.core.plan.builtin.SuspensionTrigger;
...
public final class PlanToAgentInterface {
	...
	public PlanToAgentInterface(final Agent agent){
		this.agent = agent;
	}
