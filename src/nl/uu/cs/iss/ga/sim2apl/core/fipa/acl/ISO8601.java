 ...
 * @version $Date: 2003-11-20 11:55:37 +0100 (Thu, 20 Nov 2003) $ $Revision:
 *          4572 $ Modified by:
...
public class ISO8601 {
	...
	public synchronized static Date toDate(String dateTimeToken) throws Exception {
		...
		if ((sign == plus) || (sign == minus)) {
			...
			logger.log(ISO8601.class, "sign=" + sign + " millisec=" + millisec);
			logger.log(ISO8601.class, year + " " + month + " " + day + " " + hour);
			logger.log(ISO8601.class, "currentTime=" + System.currentTimeMillis());
	 ...
	 * 
	 * @param useUTCtime
	 *            controls the style used by <code>toString</code>, 'true' generates
	 *            tokens using UTC time, 'false' using local time. If you need to
	 *            send messages to agents compiled with older versions of Jade, then
	 *            set this to <code>false</code>.
	 * @return a String, e.g. "19640625T073000000Z" to represent 7:30AM on the 25th
	 *         of June of 1964, UTC time.
	 */
	...
	/**
	 * this method converts into a string in ISO8601 format representing relative
