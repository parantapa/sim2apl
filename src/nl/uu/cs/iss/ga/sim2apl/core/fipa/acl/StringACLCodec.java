...
import nl.uu.cs.iss.ga.sim2apl.core.fipa.FIPANames;
...
public class StringACLCodec implements ACLCodec {
	 ...
	 * codec.
	 */
	public static final String NAME = FIPANames.ACLCodec.STRING;
	...
	/**
	 * if there was an automatic Base64 encoding, then it performs automatic
	 * decoding.
	 **/
	private void checkBase64Encoding(ACLMessage msg) {
		String encoding = msg.getUserDefinedParameter(BASE64ENCODING_KEY);
		if (BASE64ENCODING_VALUE.equalsIgnoreCase(encoding)) {
			try { // decode Base64
				...
				logger.log(getClass(), Level.SEVERE, "\t\t===== E R R O R !!! =======\n");
				logger.log(getClass(), Level.SEVERE, "Missing support for Base64 conversions");
				logger.log(getClass(), Level.SEVERE, "Please refer to the documentation for details.");
				...
				logger.log(getClass(), Level.SEVERE, "\t\t===== E R R O R !!! =======\n");
				logger.log(getClass(), Level.SEVERE, "Missing support for US-ASCII encoding for Base64 conversions");
			}
	 ...
	 *             if any Exception occurs during the parsing/reading operation
	 */
	 ...
	 */
	public nl.uu.cs.iss.ga.sim2apl.core.agent.AgentID decodeAID() throws ACLCodec.CodecException {
		try {
	...
	static String toString(ACLMessage msg) {
		...
		str.append(msg.getPerformative().name() + "\n");
		nl.uu.cs.iss.ga.sim2apl.core.agent.AgentID sender = msg.getSender();
		if (sender != null)
		...
		if (msg.hasByteSequenceContent()) {
			...
			try {
				...
				logger.log(StringACLCodec.class, Level.SEVERE, "\n\t===== E R R O R !!! =======\n");
				logger.log(StringACLCodec.class, Level.SEVERE, "Missing support for Base64 conversions");
				logger.log(StringACLCodec.class, Level.SEVERE, "Please refer to the documentation for details.");
				logger.log(StringACLCodec.class, Level.SEVERE, "=============================================\n\n");
				try {
					Thread.sleep(3000);
				} catch (InterruptedException ie) {
				...
				logger.log(StringACLCodec.class, Level.SEVERE, "\n\t===== E R R O R !!! =======\n");
				logger.log(StringACLCodec.class, Level.SEVERE, "Missing support for US-ASCII encoding for Base64 conversions");
				logger.log(StringACLCodec.class, Level.SEVERE, "Please refer to the documentation for details.");
				logger.log(StringACLCodec.class, Level.SEVERE, "=============================================\n\n");
				try {
					Thread.sleep(3000);
