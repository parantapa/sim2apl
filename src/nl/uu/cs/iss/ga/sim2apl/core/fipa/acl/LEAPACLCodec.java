...
public class LEAPACLCodec implements ACLCodec {
	 ...
	 */
	@Override
	public byte[] encode(nl.uu.cs.iss.ga.sim2apl.core.fipa.acl.ACLMessage msg, String charset) {
	 ...
	 */
	@Override
	public nl.uu.cs.iss.ga.sim2apl.core.fipa.acl.ACLMessage decode(byte[] data, String charset) throws CodecException {
	...
	/**
	 */
	public final static void serializeACL(nl.uu.cs.iss.ga.sim2apl.core.fipa.acl.ACLMessage msg, DataOutputStream dos) throws IOException {
	 ...
	 */
	public final static nl.uu.cs.iss.ga.sim2apl.core.fipa.acl.ACLMessage deserializeACL(DataInputStream dis) throws IOException, URISyntaxException {
		nl.uu.cs.iss.ga.sim2apl.core.fipa.acl.ACLMessage msg = new ACLMessage(dis.readByte());
